...
#Create base map
base_map <- ggmap::get_map(c(73.76, 41.16), source = "stamen", maptype = "watercolor", crop = FALSE)

#Plot points over map
ggmap(base_map) + 
  geom_point(mapping = aes(x = buoy.lon.AQUA, y = buoy.lat.AQUA), data = orig_filtered, alpha = .5, color = 'darkred', size = 3)
```
