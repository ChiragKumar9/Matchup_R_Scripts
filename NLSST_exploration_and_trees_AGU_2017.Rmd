...
breaks <- breaks * dim(orig)[1] / 50000
...
p <- ggplot2::ggplot() +
  ...
  ggsave('x2_vs_TD_cumulative_contours.pdf', device = 'pdf', width = 8, height = 6, units = 'in')
...
rasterVis::gplot(cell5deg) + 
  ...
  xlim(-2, 122) +
  ylim(-.1, 22) + 
  ggsave('x2_vs_TD_raster.pdf', device = 'pdf', width = 8, height = 6, units = 'in')
```
...
ggplot2::ggplot() +
  ...
  ggsave('M5P_predictions_vs_actual_residual.pdf', device = 'pdf', width = 8, height = 6, units = 'in')
```
...
M5P_model_residuals_test <- M5Pr_tree_test_vals - orig_test$SST.resid.SMB
...
ggplot2::ggplot() +
  ...
  ggsave('M5P_predictions_within_interval.pdf', device = 'pdf', width = 8, height = 6, units = 'in')
