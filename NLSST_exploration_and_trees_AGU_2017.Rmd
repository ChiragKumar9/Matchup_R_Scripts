...
rasterVis::gplot(cell5deg) + 
  ...
  labs(x = '(T_11 - T_12) * Reference SST', y = 'Temperature Deficit', fill = 'Fraction of Good Retrievals') +
  ggplot2::theme_bw()
```
...
table(cut(orig$SST.resid.SMB, c(-Inf, -0.4, 0.4)))

prop.table(table(cut(orig$SST.resid.SMB, c(-Inf, -0.4, 0.4))))
```
