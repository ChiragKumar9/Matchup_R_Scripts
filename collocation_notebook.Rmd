...
modis.colloc.vars <- paste0(modis.colloc.vars, ".AQUA")
modis.colloc.vars["buoy.date.AQUA"] <- "buoy.date"
modis.colloc.vars["buoy.id.AQUA"] <- "buoy.id"
