...
if (Sys.info()["sysname"] == 'Windows') {
  ...
  # Name of .Rdata file (update as needed)
  linux.file <- 'VIIRS_Suomi_NPP_MIA_L2GEN_ALL_Class_6.4.1_ao_2016_11_23_with_ancillary.Rdata'
...
if (Sys.info()["sysname"] == 'Windows') {
  ...
  linux.dir <- '~/Projects/Matchup_R_Scripts/Results/objects/'
  # Name of .Rdata file (update as needed)
  linux.file <- 'MODIS_Aqua_GSFC_ALL_Class_6.4.1_ao_2016_11_23_with_ancillary.Rdata'
