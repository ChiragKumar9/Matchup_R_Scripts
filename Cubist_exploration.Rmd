...
cat('Summary statistics of train residuals: ')
...
Cubist_rules_expl <- Cubist::cubist(x = SSES_df_train[, c('td_resid',
                                                          ...
                                                          'month',
                                                          'sd11')],
                                    y = SSES_df_temp_train$SST.resid.SMB,
                                    committees = 1,
...
yyy <- data.frame(Y = Cubist_rules_test_vals, X = SSES_df_temp_test$SST.resid.SMB)
...
```{r statistics_for_model_evaluation, echo=TRUE}
### Train set
cat('TRAIN SET: ')
...
RMSE_test_cubist <- caret::RMSE(Cubist_rules_test_vals, SSES_df_temp_test$SST.resid.SMB)
cat('RMSE test: ')
RMSE_test_cubist
MAE_test_cubist <- mean(abs(Cubist_rules_test_vals - SSES_df_temp_test$SST.resid.SMB))
cat('MAE test: ')
MAE_test_cubist
cat('IQR of model residuals: ')
IQR(Cubist_rules_test_vals - SSES_df_temp_test$SST.resid.SMB)
cat('median of model residuals: ')
median(Cubist_rules_test_vals - SSES_df_temp_test$SST.resid.SMB)
cat('Correlation of model predictions')
cor(Cubist_rules_test_vals, SSES_df_temp_test$SST.resid.SMB)
cat('Index of Agreement of model predictions')
hydroGOF::d(Cubist_rules_test_vals, SSES_df_temp_test$SST.resid.SMB)
