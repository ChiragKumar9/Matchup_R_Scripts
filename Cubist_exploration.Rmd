...
orig2 <- orig %>%
  ...
  dplyr::select(td_estimate, x2, abs_satz, sd11, ref_SST, lat, month, SST.resid.SMB)
...
SSES_df_temp <- as.data.frame(SSES_df_temp)
SSES_df_temp$abs_satz <- abs(SSES_df_temp$satz)
```
