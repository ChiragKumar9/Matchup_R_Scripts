...
* Cubist/M5P Tree Regression    
    ...
    + To quantify the certainty of residual estimate, empirical table of test set accuracy windows
        + 14.0% of actual residuals fall within $\pm$ .1 deg C of predicted residual
        + 27.5% of actual residuals fall within $\pm$ .2 deg C of predicted residual
        + 40.2% of actual residuals fall within $\pm$ .3 deg C of predicted residual
        + 51.6% of actual residuals fall within $\pm$ .4 deg C of predicted residual
        + 61.6% of actual residuals fall within $\pm$ .5 deg C of predicted residual
        + 79.1% of actual residuals fall within $\pm$ .75 deg C of predicted residual
        + 88.4% of actual residuals fall within $\pm$ 1.0 deg C of predicted residual
        + 92.5% of actual residuals fall within $\pm$ 1.2 deg C of predicted residual
