...
* Analyzed retrievals for which the tree was mispredicting the residual range
    ...
    + T-test: Disagreements form different population than residuals as a whole (p < 0.001)
...
* Cubist/M5P Tree Regression    
    ...
    + To quantify the certainty of residual estimate, empirical table of test set accuracy windows (MAKE INTO GRAPH!)
...
Caption: Figure 5: Error breakdowns for predictions from the Cubist Decision Tree Regression Algorithm
