...
orig <- dplyr::tbl_df(AQUA) %>%
  ...
  dplyr::select(T_11, x2, x3, satz, lon, lat, sd11, sd12, range11, range12, diff.med.min11, diff.med.min12, band.diff, qsst, buoy.sst, cell5deg,
                buoy.timedate, T_12, ref_SST, SST.resid.SMB)
...
# Plot tree
rpart.plot::prp(rpart_tree, uniform = TRUE,
