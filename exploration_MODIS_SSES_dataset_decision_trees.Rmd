...
orig_train3 <- DMwR::SMOTE(class_resid ~ ., as.data.frame(orig_train2), perc.over = 200, perc.under = 200)

# ROSE

orig_train3 <- ROSE::ROSE(class_resid ~ ., as.data.frame(orig_train2), seed = 42)$data
