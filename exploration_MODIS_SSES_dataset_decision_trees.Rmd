...
orig_train <- DMwR::SMOTE(class_resid ~ ., orig_train, perc.over = 100, perc.under = 200)
...
# For evaluation purposes, also analyze the accuracy and cm of the train set
# Evaluate the decision tree's accuracy on validation set
ctree_tree_predictions_traom <- predict(ctree_tree, newdata = orig_train, type = 'response', na.action = na.pass)
