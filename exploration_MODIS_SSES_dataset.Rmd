...
orig <- dplyr::tbl_df(AQUA) %>%
  ...
  dplyr::select(x1, x2, x3, satz, lon, lat, sd11, sd12, range11, range12, diff.med.min11, diff.med.min12, band.diff, qsst, buoy.sst, SST.resid.SMB)
...
(Fill in some basic stuff about what we found)
