...
# Rule 6
orig_b$rule_numb[orig_b$rule_numb <- NA & orig_b$td_resid > -0.6436465 & orig_b$x2 <= 58.57362 & orib_b$satz > 1.9999 & orig_b$satz <= 40.15 & orig_b$ref_SST > 24.74] <- 6
...
orig_test <- orig_b[(nrow(orig_train) + 1):nrow(orig_test), ]
