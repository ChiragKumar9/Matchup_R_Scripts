...
committees <- seq(from = 1, to = 100)
rules <- seq(from = 1, to = 500)
ctrl_params_performance <- expand.grid(committees = committees, rules = rules)
...
for (N in 1:nrow(ctrl_params_performance)) {
  committees_specific <- committees[N]
  ...
  cat('Committees:', committees_specific, 'out of 100; Rules:', rules_specific, 'out of 500; RMSE Test:', RMSE_test_cubist, '\n')
}
